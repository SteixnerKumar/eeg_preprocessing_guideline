...
function [EEG, com] = sk_pop_subcomp( EEG, components, plotag, keepcomp)
...
compproj = EEG.icawinv(:, component_keep)*sk_eeg_getdatact(EEG, 'component', component_keep, 'reshape', '2d');
% compproj = EEG.icawinv(:, component_keep)*EEG.icaact;
